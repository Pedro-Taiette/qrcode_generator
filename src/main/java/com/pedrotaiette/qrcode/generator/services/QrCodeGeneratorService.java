package com.pedrotaiette.qrcode.generator.services;
...
import com.pedrotaiette.qrcode.generator.ports.StoragePort;
...
public class QrCodeGeneratorService {
    ...
    public QrCodeGenerateResponse generateAndUploadQrCode(String text) throws WriterException, IOException {
        ...
        ByteArrayOutputStream pngOutputStram = new ByteArrayOutputStream();
        MatrixToImageWriter.writeToStream(bitMatrix, "PNG", pngOutputStram);
        byte[] pngQrCodeData = pngOutputStram.toByteArray();
